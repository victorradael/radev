...
export function ProjectDetail({ project, onClose }: ProjectDetailProps) {
    return (
        ...
        >
            ...
            <div className="w-full md:w-2/5 relative p-8 flex flex-col items-center justify-center bg-gradient-to-br from-[#0d1117] to-[#161b22] shrink-0">
                <motion.div
                    layoutId={`image-${project.id}`}
                    className="relative w-48 h-48 rounded-3xl overflow-hidden shadow-2xl mb-6 flex items-center justify-center bg-white/5 shrink-0 aspect-square"
                >
                    {project.emoji ? (
            ...
            {/* Right Side - Content */}
            <div className="w-full md:w-3/5 p-8 md:p-12 bg-[#0d1117] text-white flex flex-col overflow-y-auto">
                <motion.div
