        ...
        <div className="flex space-x-1 bg-black/20 backdrop-blur-md p-1 rounded-full border border-white/10 mb-6 relative z-10 w-fit mx-auto">
            {tabs.map((tab) => (
                <button
                    ...
                    className={`
            relative px-4 md:px-6 py-2 rounded-full text-sm font-medium transition-colors duration-200 outline-none focus-visible:ring-2 focus-visible:ring-white/50
